 ...
 */
public class ActionVac implements ActionMode.Callback, DialogInterface.OnClickListener {
    ...
    public ActionVac(Context activity, CustomAdapter xadapter){
        vac_manager = new DB_Vacations_Manager(activity, DB_Helper.DB_Name, DB_Helper.DB_Version);
        adapter = xadapter;
    }
    ...
    private void delete() {
        for(int i = 0; i < selected.size(); i++){
            ...
            vac_manager.delete(selected.get(i).name);
        }
