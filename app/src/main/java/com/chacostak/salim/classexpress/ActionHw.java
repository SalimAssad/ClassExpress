 ...
 */
public class ActionHw implements ActionMode.Callback, DialogInterface.OnClickListener {
    ...
    public ActionHw(Context activity, CustomAdapter xadapter){
        hw_manager = new DB_Homework_Manager(activity, DB_Helper.DB_Name, DB_Helper.DB_Version);
        adapter = xadapter;
    }
    ...
    private void delete() {
        for(int i = 0; i < selected.size(); i++){
            ...
            hw_manager.deleteByTitle(selected.get(i).name);
        }
